...
class StoryList {
  ...
  // Deletes story from API and removes from storyLists
  // user - the current user instance
  // storyId - the ID of the story wanting to remove
...
class User {
  ...
  // Allow users to favorite and unfavorite stories
...
// Options to discuss with Mentor:
// function toggleStoryFavorite(evt) {
//   console.debug("toggleStoryFavorite");

//   if (evt.target.classList.contains("fas") === true) {
...
// static toggleStoryFavorite(evt) {
